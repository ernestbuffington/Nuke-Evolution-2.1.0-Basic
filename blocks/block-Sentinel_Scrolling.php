...
function block_SentinelScrolling_cache($block_cachetime) {
    global $db, $cache;
...
$blocksession = block_SentinelScrolling_cache($evoconfig['block_cachetime']);
...
if (empty($blockcontent)) {
    ...
    $content .= "<div style='width: 100%; height: 200px; text-align: center;'>\n";
    $content .= evo_marquee('block_Sentinel_Scrolling', '100%', '100%', $blockcontent, 'down', 1, '100%', '100%' , 0, 0);
    $content .= "</div>\n";
}
$content .= "</div>\n";
