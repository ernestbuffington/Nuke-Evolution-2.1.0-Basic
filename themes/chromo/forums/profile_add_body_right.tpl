<form action="{S_PROFILE_ACTION}" {S_FORM_ENCTYPE} method="post">
    ...
    <table id="reginfo"  cellpadding="3" cellspacing="1" width="100%" class="forumline">
        <tr>
        ...
        <tr>
            ...
            <td class="row2">
                <input type="text" class="post" style="width:200px" name="rname" size="25" maxlength="25" value="{RNAME}" />
            </td>
        </tr>
        <tr>
            <td class="row1">
...
<table id="profileinfo" style="display:none"  cellpadding="3" cellspacing="1" width="100%" class="forumline">
<tr>
...
<!-- BEGIN switch_is_signature -->
        <tr>
            ...
            <td class="row2">
                <textarea class="post" cols='50' rows='5' name='extra_info'>{EXTRA_INFO}</textarea>
            </td>
        </tr>
        <tr>
            <td class="row1">
            ...
            <td class="row2">
                <input type="button" value="{SIG_BUTTON_DESC}" onclick="document.location.href='{SIG_EDIT_LINK}'" />
            </td>
        </tr>
...
<!-- BEGIN options -->
                ...
                <span class="gen">
                    {xdata.switch_type_radio.options.OPTION}
                </span>
                <br />
<!-- END options -->
            </td>
...
<table id="prefinfo" style="display:none"  cellpadding="3" cellspacing="1" width="100%" class="forumline">
<tr>
...
<!-- BEGIN force_word_wrapping -->
        <tr>
            ...
            <td class="row2">
                <span class="gensmall">
                    <input type="text" name="user_wordwrap" value="{WRAP_ROW}" size="2" maxlength="2" class="post" />&nbsp;{L_WORD_WRAP_EXTRA}
                </span>
            </td>
        </tr>
...
<!-- BEGIN switch_avatar_block -->
     <table id="avatarinfo" style="display:none"  cellpadding="3" cellspacing="1" width="100%" class="forumline">
        <tr>
...
<table cellpadding="4" cellspacing="1"  class="forumline" width="200">
<tr>
	<th class="thHead">{L_EDIT_PROFILE_MENU_TITLE}</th>
</tr>
<tr>
...
<table id="avatarinfo_cur" style="display:none" cellpadding="4" cellspacing="1"  class="forumline" width="100%">
<tr>
