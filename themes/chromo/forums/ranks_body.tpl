<table width="100%" cellspacing="2" cellpadding="2" >
    <tr>
        <td align="left" valign="middle" width="100%">
            <span class="nav">
                <a href="{U_INDEX}" class="nav">{L_INDEX}</a>&nbsp;->&nbsp;{L_RANKS}
            </span>
        </td>
    </tr>
</table>
    ...
    <tr>
        <td valign="top" width="50%">
            <table  cellpadding="4" cellspacing="1" class="forumline" width="100%">
                ...
                <tr>
                    <td class="catLeft" nowrap="nowrap" align="center">
                        <span class="cattitle">
                            &nbsp;{L_RANKS}&nbsp;
                        </span>
                    </td>
...
<!-- END no_userlist -->
                        <span class="gen">
                            {ranks.RANK_TITLE}<br />{ranks.RANK_IMAGE}
                        </span>
                    </td>
...
<!-- BEGIN spe_ranks -->
                <tr>
                    <td class="row1" align="center" nowrap="nowrap">
                        <span class="gen">
                            {spe_ranks.RANK_TITLE}<br />{spe_ranks.RANK_IMAGE}
                        </span>
                    </td>
<!-- BEGIN userlist -->
                    <td class="row2" valign="top">
                        <span class="gensmall">
                            {spe_ranks.userlist.USERS_LIST}
                        </span>
                    </td>
<!-- END userlist -->
<!-- BEGIN no_userlist -->
                    <td class="row2" align="center" valign="top">
                        <span class="gensmall">
                            {spe_ranks.no_userlist.RANK_TOTAL}
                        </span>
                    </td>
<!-- END no_userlist -->
                </tr>
