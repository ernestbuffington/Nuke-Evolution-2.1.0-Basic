...
<!-- END poll_option_rows -->
            ...
            <tr>
                <td class="row1">
                    <span class="gen">
                        <strong>{L_POLL_TOGGLE}</strong>
                    </span>
                </td>
                <td class="row2">
                    <span class="genmed">
                        <input type="checkbox" name="poll_view_toggle" value="1" {POLL_TOGGLE_CHECKED} />
                    </span>
                    <span class="gen">
                        &nbsp;
                    </span>
                    <span class="gensmall">
                        {L_POLL_TOGGLE_EXPLAIN}
                    </span>
                </td>
            </tr>
