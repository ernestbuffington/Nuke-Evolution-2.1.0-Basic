    ...
    <table width="99%" align="center" cellpadding="4" cellspacing="1"  class="forumline">
      ...
      <tr>
        <td class="row1" align="center" valign="middle">
            <input type="text" size="8" maxlength="15" name="add_extension" class="post" value="" />
        </td>
      ...
      <tr>
          <td class="row1" align="center" valign="middle">
              <span class="postdetails">
                  {extensionrow.EXTENSION_NAME}
              </span>
          </td>
          <td class="row2" align="center" valign="middle">
              <input type="checkbox" name="extension_id_list[]" value="{extensionrow.EXTENSION_ID}" />
          </td>
      </tr>
<!-- END extensionrow -->
      <tr align="right">
