...
<!-- BEGIN votes -->
        <tr>
            <td class="{votes.COLOR}" border="1" align="center">
                <span class="gensmall">
                    {votes.VOTE_ID}
                </span>
            </td>
            <td class="{votes.COLOR}" border="1">
                <span class="genmed">
                    <script language="JavaScript" type="text/javascript">
                    <!--
            ...
            <td class="{votes.COLOR}" border="1" align="center" width="120">
                <span class="gensmall">
                    {votes.VOTE_DURATION}
                </span>
            </td>
...
<!-- BEGIN detail -->
                    <tr>
                        <td class="row1">
                            {votes.detail.OPTION}&nbsp;({votes.detail.RESULT})
                        </td>
                        <td class="row3">
                            <span class="gensmall">
                                {votes.detail.USER}
...
<!-- END votes -->
        <tr>
            <td class="catBottom" height="18" align="center" valign="middle" colspan="4">
                &nbsp;
            </td>
        </tr>
    </table>
    ...
    <div align="center">
        <span class="copyright">
            Admin&nbsp;Voting&nbsp;&nbsp;v1.1.8&nbsp;&nbsp;&copy&nbsp;2002&nbsp;&nbsp;
            <a href="mailto:ErDrRon@aol.com">ErDrRon</a>
        </span>
    </div>
</form>