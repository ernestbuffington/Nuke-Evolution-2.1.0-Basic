    ...
    <table width="99%" align="center" cellpadding="4" cellspacing="1"  class="forumline">
        ...
        <tr>
            <td class="row1" align="center" valign="middle">
                <input type="text" size="20" maxlength="25" name="quota_description" class="post" value="" />
            </td>
            <td class="row2" align="center" valign="middle">
                <input type="text" size="8" maxlength="15" name="add_max_filesize" class="post" value="{MAX_FILESIZE}" />&nbsp;{S_FILESIZE}
            </td>
            <td class="row1" align="center" valign="middle">
                <input type="checkbox" name="add_quota_check" />
            </td>
        </tr>
        <tr align="right">
...
<!-- BEGIN limit_row -->
        <tr>
                ...
                <table width="100%" align="center" cellpadding="0" cellspacing="0" >
                    <tr>
                        <td class="row1" align="center" valign="middle" width="10%" wrap="nowrap">
                            <span class="gensmall">
                                <strong><a href="{limit_row.U_VIEW}" class="gensmall">{L_VIEW}</a></strong>
                            </span>
                        </td>
            ...
            <td class="row2" align="center" valign="middle">
                <input type="text" size="8" maxlength="15" name="max_filesize_list[]" class="post" value="{limit_row.MAX_FILESIZE}" />{limit_row.S_FILESIZE}
            </td>
            <td class="row1" align="center" valign="middle">
                <input type="checkbox" name="quota_id_list[]" value="{limit_row.QUOTA_ID}" />
            </td>
        </tr>
<!-- END limit_row -->
        <tr align="right">
