...
<form method="post" action="{S_USER_ACTION}">
    ...
    <table cellspacing="1" cellpadding="4"  align="center" class="forumline">
        ...
        <tr>
            <td class="row1" align="right">
                <strong>{L_EMAIL_SUBJECT}</strong>
            </td>
            <td class="row2">
                <span class="gen">
                    <input type="text" name="subject" size="45" maxlength="100" tabindex="2" class="post" value="{SUBJECT}" />
                </span>
            </td>
        </tr>
        <tr>
            <td class="row1" align="right" valign="top">
                <span class="gen">
                    <strong>{L_EMAIL_MSG}</strong>
                </span>
            <td class="row2">
                <span class="gen">
                    <textarea name="message" rows="15" cols="35" style="width:450px" tabindex="3" class="post">{MESSAGE}</textarea>
                </span>
        </tr>
        <tr>
