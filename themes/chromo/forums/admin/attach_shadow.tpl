        ...
        <tr>
            <td class="row2" align="center" valign="middle">
                <span class="postdetails">
                    <a class="postdetails" href="{file_shadow_row.U_ATTACHMENT}" target="_blank">{file_shadow_row.ATTACH_FILENAME}</a>
                </span>
            </td>
            <td class="row1" align="center" valign="middle">
                <span class="postdetails">
                    {file_shadow_row.ATTACH_COMMENT}
                </span>
            </td>
            <td class="row2" align="center" valign="middle">
...
<!-- BEGIN table_shadow_row -->
        <tr>
            ...
            <td class="row1" align="center" valign="middle">
                <span class="postdetails">
                    {table_shadow_row.ATTACH_COMMENT}
                </span>
            </td>
            <td class="row2" align="center" valign="middle">
...
<!-- END table_shadow_row -->
        <tr align="right">
            <td class="catBottom" colspan="5" height="29">
                <input type="submit" name="submit" class="liteoption" value="{L_DELETE_MARKED}" />
            </td>
        </tr>
    </table>
    {S_HIDDEN}
