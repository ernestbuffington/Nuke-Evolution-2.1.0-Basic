...
<form action="{S_PROFILE_ACTION}" {S_FORM_ENCTYPE} method="post">
    <table width="98%" cellspacing="1" cellpadding="4"  align="center" class="forumline">
        <tr>
...
<!-- END avatar_local_gallery -->
        ...
        <tr>
            ...
            <td class="row2">
                <input type="radio" name="user_allowsignature" value="1" {ALLOW_SIG_YES} />
                    <span class="gen">
                        {L_YES}
                    </span>
                &nbsp;&nbsp;
                <input type="radio" name="user_allowsignature" value="0" {ALLOW_SIG_NO} />
                    <span class="gen">
                        {L_NO}
                    </span>
            </td>
        ...
        <tr>
            ...
            <td class="row2">
                <input type="text" name="user_posts" value="{USER_POSTS}" />
            </td>
        </tr>
        <tr>
            <td class="row1">
        ...
        <tr>
            ...
            <td class="row2">
                <input type="checkbox" name="deleteuser" />{L_DELETE_USER_EXPLAIN}
            </td>
        </tr>
        <tr>
