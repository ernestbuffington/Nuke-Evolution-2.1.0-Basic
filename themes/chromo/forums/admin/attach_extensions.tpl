    ...
    <table width="100%" align="center" cellpadding="4" cellspacing="1"  class="forumline">
        ...
        <tr>
            <td class="row1" align="center" valign="middle">
                <input type="text" size="30" maxlength="100" name="add_extension_explain" class="post" value="{ADD_EXTENSION_EXPLAIN}" />
            </td>
            <td class="row2" align="center" valign="middle">
                <input type="text" size="20" maxlength="100" name="add_extension" class="post" value="{ADD_EXTENSION}" />
            </td>
            <td class="row1" align="center" valign="middle">
                {S_ADD_GROUP_SELECT}
            </td>
            <td class="row2" align="center" valign="middle">
                <input type="checkbox" name="add_extension_check" />
            </td>
        </tr>
        <tr align="right">
...
<!-- BEGIN extension_row -->
        <tr>
            ...
            <td class="row1" align="center" valign="middle">
                <input type="text" size="30" maxlength="100" name="extension_explain_list[]" class="post" value="{extension_row.EXTENSION_EXPLAIN}" />
            </td>
            <td class="row2" align="center" valign="middle">
                <span class="gen">
                    <strong>{extension_row.EXTENSION}</strong>
                </span>
            </td>
            <td class="row1" align="center" valign="middle">
