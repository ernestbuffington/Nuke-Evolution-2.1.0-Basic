...
<form action="{S_GROUP_ACTION}" method="post" name="post">
    <table  cellpadding="3" cellspacing="1" class="forumline" align="center">
        <tr>
        ...
        <tr>
            <td class="row1" width="38%">
                <span class="gen">
                    {L_GROUP_COUNT}:<br />{L_GROUP_COUNT_MAX}:
                </span>
                <br />
                <span class="gensmall">
                    {L_GROUP_COUNT_EXPLAIN}
                </span>
            </td>
            <td class="row2" width="62%">
                <input type="text" class="post" name="group_count" maxlength="12" size="12" value="{GROUP_COUNT}" /><br />
                <input type="text" class="post" name="group_count_max" maxlength="12" size="12" value="{GROUP_COUNT_MAX}" /><br />
                <span class="gen">
                    &nbsp;&nbsp;<input type="checkbox" name="group_count_enable" {GROUP_COUNT_ENABLE_CHECKED} />&nbsp;{L_GROUP_COUNT_ENABLE}<br />
                    &nbsp;&nbsp;<input type="checkbox" name="group_count_update" value="0" />&nbsp;{L_GROUP_COUNT_UPDATE}<br />
                    &nbsp;&nbsp;<input type="checkbox" name="group_count_delete" value="0" />&nbsp;{L_GROUP_COUNT_DELETE}
                </span>
            </td>
        </tr>
<!-- Start add - Initial Usergroup Mod -->
        <tr>
            <td class="row1" width="38%">
                ...
                <br />
                <span class="gensmall">
                    {L_GROUP_INITIAL_EXPLAIN}
                </span>
            </td>
            <td class="row2" width="62%">
                <input type="radio" name="initial_group" value="{S_GROUP_INITIAL_YES_TYPE}" {S_GROUP_INITIAL_YES_CHECKED} />{L_YES}&nbsp;&nbsp;
                <input type="radio" name="initial_group" value="{S_GROUP_INITIAL_NO_TYPE}" {S_GROUP_INITIAL_NO_CHECKED} />{L_NO}
            </td>
       </tr>
...
<!-- Start add - Enhanced BBGroups MOD -->
        <tr>
            ...
            <td class="row2" width="62%">
                <input type="text" class="post" name="max_inbox" maxlength="10" size="10" value="{MAX_INBOX}" />
                <input type="checkbox" name="override_max_inbox" value="{OVERRIDE_MAX_INBOX}" />{L_OVERRIDE_MAX}
            </td>
        </tr>
        <tr>
            <td class="row1" width="38%">
            ...
            <td class="row2" width="62%">
                <input type="text" class="post" name="max_sentbox" maxlength="10" size="10" value="{MAX_SENTBOX}" />
                <input type="checkbox" name="override_max_sentbox" value="{OVERRIDE_MAX_SENTBOX}" />{L_OVERRIDE_MAX}
            </td>
        </tr>
        <tr>
            <td class="row1" width="38%">
            ...
            <td class="row2" width="62%">
                <input type="text" class="post" name="max_savebox" maxlength="10" size="10" value="{MAX_SAVEBOX}" />
                <input type="checkbox" name="override_max_savebox" value="{OVERRIDE_MAX_SAVEBOX}" />{L_OVERRIDE_MAX}
            </td>
        </tr>
