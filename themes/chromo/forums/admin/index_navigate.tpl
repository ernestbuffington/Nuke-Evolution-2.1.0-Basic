...
<table width="100%" cellpadding="4" cellspacing="0"  align="center">
    <tr>
        <td align="center" >
            ...
            <img src="{PHPBB_LOGO_IMG}" alt="phpBB"  /></a>
        </td>
    </tr>
    <tr>
        <td align="center" >
...
<!-- BEGIN catrow -->
                <tr>
                    <td height="28" class="catSides" style="cursor:pointer;" onclick="onMenuCatClick('{catrow.MENU_CAT_ID}');">
                        <span class="cattitle">
                ...
                <tr>
                    <td class="row1">
                        <div id="menuCat_{catrow.MENU_CAT_ID}" style="display:block;">
                            <table width="100%" cellpadding="4" cellspacing="1"  class="bodyline">
<!-- BEGIN modulerow -->
                                <tr>
                                    <td class="row1">
