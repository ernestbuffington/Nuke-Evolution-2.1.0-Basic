<form method="post" action="{S_MODCP_ACTION}">
    ...
    <table width="100%" cellpadding="4" cellspacing="1"  class="forumline">
        <tr>
            <td class="catHead" colspan="6" align="center" height="28">
                <span class="cattitle">
                    {L_MOD_CP}
                </span>
            </td>
        ...
        <tr>
            <td class="spaceRow" colspan="6" align="center">
                <span class="gensmall">
                    {L_MOD_CP_EXPLAIN}
                </span>
            </td>
        ...
        <tr>
            ...
            <td class="row1">
                <span class="topictitle">
                    &nbsp;{topicrow.TOPIC_ATTACHMENT_IMG}{topicrow.TOPIC_TYPE}<a href="{topicrow.U_VIEW_TOPIC}" class="topictitle">{topicrow.TOPIC_TITLE}</a>
                </span>
            </td>
