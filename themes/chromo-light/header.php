...
echo "        <td style=\"background-image: url(themes/chromo-light/images/bnr_03_tile.gif)\"><img src=\"themes/".$theme_name."/images/spacer.gif\" alt=\"\" width=\"1\" height=\"1\" /></td>\n";
...
echo "      <table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\n";
echo "        <tr>\n";
echo "          <td width=\"61\" height=\"98\"><img src=\"themes/".$theme_name."/images/bnr_06.jpg\" alt=\"\" width=\"61\" height=\"98\" /></td>\n";
echo "          <td width=\"317\"><img src=\"themes/".$theme_name."/images/bnr_07_logo.jpg\" alt=\"".EVO_SERVER_SITENAME."\" width=\"317\" height=\"98\" /></td>\n";
$ads = ads(0);
if(empty($ads)) {
    echo "          <td style=\"background-image: url(themes/chromo-light/images/bnr_08_tile.gif)\"><img src=\"themes/".$theme_name."/images/spacer.gif\" alt=\"\" width=\"1\" height=\"1\" /></td>\n";
} else {
    echo "          <td style=\"background-image: url(themes/chromo-light/images/bnr_08_tile.gif)\">$ads</td>\n";
}
echo "          <td width=\"62\"><img src=\"themes/".$theme_name."/images/bnr_09.gif\" alt=\"\" width=\"62\" height=\"98\" /></td>\n";
echo "          <td width=\"61\"><img src=\"themes/".$theme_name."/images/bnr_10.jpg\" alt=\"\" width=\"61\" height=\"98\" /></td>\n";
echo "        </tr>\n";
echo "      </table>\n";
echo "      <table width=\"100%\" border=\"0\" cellspacing=\"0\" cellpadding=\"0\">\n";
echo "        <tr>\n";
echo "          <td width=\"72\" height=\"34\"><img src=\"themes/".$theme_name."/images/bnr_11.gif\" alt=\"\" width=\"72\" height=\"34\" /></td>\n";
echo "          <td style=\"background-image: url(themes/chromo-light/images/bnr_12_tile.gif)\"><img src=\"themes/".$theme_name."/images/spacer.gif\" alt=\"\" width=\"1\" height=\"1\" /></td>\n";
...
echo "          <td style=\"background-image: url(themes/chromo-light/images/bnr_14_tile.jpg)\"><img src=\"themes/".$theme_name."/images/spacer.gif\" alt=\"\" width=\"1\" height=\"1\" /></td>\n";
echo "          <td width=\"478\">\n";
