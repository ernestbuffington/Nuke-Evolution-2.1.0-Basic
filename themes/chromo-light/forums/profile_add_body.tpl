...
<!-- END switch_ya_merge -->
        <tr>
            <td class="catSides" colspan="2" height="28">
...
<!-- BEGIN switch_avatar_block -->
        ...
        <tr>
            <td class="row1" colspan="2">
                <table width="70%" cellspacing="2" cellpadding="0"  align="center">
                    <tr>
                        <td width="65%">
                            <span class="gensmall">
                                {L_AVATAR_EXPLAIN}
...
<!-- END switch_avatar_block -->
        <tr>
            <td class="catBottom" colspan="2" align="center" height="28">
                {S_HIDDEN_FIELDS}<input type="submit" name="submit" value="{L_SUBMIT}" class="mainoption" />&nbsp;&nbsp;
