...
<!-- BEGIN attach_row -->
  <tr>
    ...
    <td class="row2">
        <span class="gen">
            <a class="gen" href="{attach_row.U_VIEW_ATTACHMENT}" target="_blank">{attach_row.FILE_NAME}</a>
        </span>
    </td>
  </tr>
  <tr>
    ...
    <td class="row2">
        <span class="genmed">
            <textarea name="comment_list[]" rows="3" cols="35" style="width: 300px" class="post">{attach_row.FILE_COMMENT}</textarea>
        </span>
    </td>
  </tr>
  <tr>
