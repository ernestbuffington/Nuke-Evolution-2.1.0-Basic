...
function updateButton()
{
  if ( ticker >= 0)
  {
    if ( ticker == 0 )
    {
      ...
      document.form_rebuild_progress.submit();
    }
    else
    {
...
<form name="form_rebuild_progress" method="post" action="{S_REBUILD_SEARCH_ACTION}">
    <table width="540" cellspacing="1" cellpadding="2"  align="center" class="forumline">
        <tr>
        ...
        <tr>
            <td class="row1" align="center">
                <span class="genmed">
                    {PROCESSING_POSTS}<br /><br />
                    {PROCESSING_MESSAGES}
                </span>
                <br />
                <img name="progress_bar" src="{PROGRESS_BAR_IMG}"  />
            </td>
        </tr>
        <tr>
                ...
                <table width="100%" align="center" cellspacing="1" cellpadding="1" class="forumline">
                    ...
                    <tr>
                        ...
                        <td class="row3" nowrap="nowrap" align="center">
                            <span class="genmed">
                                <strong>{L_PROCESSED_POSTS}</strong>
                            </span>
                        </td>
                        <td class="row3" nowrap="nowrap" align="center">
                            <span class="genmed"><strong>{L_PERCENT}</strong></span>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="row1" width="200"  nowrap="nowrap" align="center">
                            <span class="genmed"><strong>{SESSION_PERCENT}</strong></span><br />
                            {SESSION_PERCENT_BOX}
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="row2" width="200" nowrap="nowrap" align="center">
                            <span class="genmed"><strong>{TOTAL_PERCENT}</strong></span><br />
                            {TOTAL_PERCENT_BOX}
                        </td>
                    </tr>
                </table>
            ...
            <td class="row3" align="center">
                <table width="100%" align="center" cellspacing="1" cellpadding="1" class="forumline">
                    ...
                    <tr>
                        ...
                        <td class="row3" nowrap="nowrap" align="center" width="304"><span class="genmed"><strong>{L_PROCESSING_TIME}</strong></span></td>
                    </tr>
                    <tr>
        ...
        <tr>
            <td class="row3" align="center">
                <table width="100%" align="center" cellspacing="1" cellpadding="1" class="forumline">
                    ...
                    <tr>
                        <td class="row3" nowrap="nowrap">&nbsp;</td>
                        <td class="row3" nowrap="nowrap" align="center" width="150"><span class="genmed"><strong>{L_SIZE_CURRENT}</strong></span></td>
                        <td class="row3" nowrap="nowrap" align="center" width="150"><span class="genmed"><strong>{L_SIZE_ESTIMATED}</strong></span></td>
                    </tr>
                    <tr>
...
<div align="center">
    <span class="copyright">
        {L_REBUILD_SEARCH}&nbsp;{REBUILD_SEARCH_VERSION}
    </span>
</div>
