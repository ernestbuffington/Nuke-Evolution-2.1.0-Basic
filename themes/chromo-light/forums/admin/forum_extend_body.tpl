...
<!-- BEGIN row -->
        <tr>
            <td width="5%" align="center" class="{row.COLOR}">
                <img src="{row.FOLDER}"  alt="{row.L_FOLDER}" title="{row.L_FOLDER}" />
            </td>
            <td class="{row.COLOR}" valign="top" height="50" width="60%">
<!-- BEGIN forum_icon -->
                <table cellpadding="2" cellspacing="0"  height="47" width="100%">
                    <tr>
                        <td width="46" align="center">
                            <img src="{row.ICON_IMG}"  alt="{row.ICON}" title="{row.ICON}" />
                        </td>
                        <td width="100%">
<!-- END forum_icon -->
                            <span class="forumlink">
                                <a href="{row.U_FORUM}" class="forumlink" title="{row.FORUM_NAME}">{row.FORUM_NAME}</a>
                            </span>
                            <span class="genmed">
                                <br />{row.FORUM_DESC}
                            </span>
...
<!-- END forum_icon -->
            ...
            <td width="5%" class="{row.COLOR}" align="center" valign="middle">
                <span class="gensmall">
                    {row.TOPICS}
                </span>
            </td>
            ...
            <td width="25%" class="{row.COLOR}" align="center">
                <table cellpadding="0" cellspacing="3"  align="center">
                    <tr>
                        <td>
                            <table cellpadding="1" cellspacing="0" border="1" align="center" width="80">
                                <tr>
                                    <td class="quote" align="center">
                                        <span class="genmed">
                                            <a href="{row.U_EDIT}" class="genmed" title="{L_EDIT}">{L_EDIT}</a>
                                        </span>
                                    </td>
                                </tr>
                            </table>
                        ...
                        <td>
                            <table cellpadding="1" cellspacing="0" border="1" align="center" width="80">
                                <tr>
                                    <td class="quote" align="center">
                                        <span class="genmed">
                                            <a href="{row.U_DELETE}" class="genmed" title="{L_DELETE}">{L_DELETE}</a>
                                        </span>
                                    </td>
                                </tr>
                            </table>
                                ...
                                <tr>
                                    <td>
                                        <table cellpadding="2" cellspacing="0" border="1" align="center">
                                            <tr>
                                                <td class="quote" align="center">
                                                    <a href="{row.U_MOVEUP}" class="genmed" title="{L_MOVEUP}"><img src="{IMG_MOVEUP}"  /></a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                                ...
                                <tr>
                                    <td>
                                        <table cellpadding="2" cellspacing="0" border="1" align="center">
                                            <tr>
                                                <td class="quote" align="center">
                                                    <a href="{row.U_MOVEDW}" class="genmed" title="{L_MOVEDW}"><img src="{IMG_MOVEDW}"  /></a>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                        ...
                        <td colspan="2">
                            <table cellpadding="1" cellspacing="0" border="1" align="center" width="80">
                                <tr>
                                    <td class="quote" align="center">
                                        <span class="genmed">
                                            <a href="{row.U_RESYNC}" class="genmed" title="{L_RESYNC}">{L_RESYNC}</a>
                                        </span>
                                    </td>
                                </tr>
                            </table>
