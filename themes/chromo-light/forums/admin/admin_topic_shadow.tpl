...
<table width="100%" cellspacing="2" cellpadding="2"  align="center">
    <tr>
        <td align="left">
            ...
            <br />
            <span class="gensmall">
                <strong>{L_VERSION}&nbsp;{VERSION}<br />{NIVISEC_CHECKER_VERSION}</strong>
            </span>
            <br /><br />
            <span class="genmed">
                {L_PAGE_DESC}<br /><br />{VERSION_CHECK_DATA}
            </span>
        </td>
    </tr>
</table>
...
<!-- BEGIN topicrow -->
        <tr>
            <td class="{topicrow.ROW_CLASS}" align="right">
                <input type="checkbox" name="delete_id_{topicrow.TOPIC_ID}" />
            </td>
            <td class="{topicrow.ROW_CLASS}"  align="left">
                <span class="gen">
                    {topicrow.TITLE}
                </span>
            </td>
            <td class="{topicrow.ROW_CLASS}" align="center" valign="middle">
                <span class="gen">
                    {topicrow.POSTER}
                </span>
            </td>
...
<!-- END emptyrow -->
        <tr>
            <td class="catbottom" colspan="6" height="28" align="center">
                <input type="submit" class="mainoption" value="{L_DELETE}" />&nbsp;&nbsp;
                <input type="reset" class="liteoption" value="{L_CLEAR}" />
            </td>
        </tr>
    </table>
</form>
    ...
    <table cellpadding="3" cellspacing="1"  class="forumline" align="center">
        ...
        <tr>
            <td class="row1" align="center">
                <input class="post" type="text" name="del_month" value="{S_MONTH}" size="2" maxlength="2" />
            </td>
            <td class="row2" align="center">
                <input class="post" type="text" name="del_day" value="{S_DAY}" size="2" maxlength="2" />
            </td>
            <td class="row1" align="center">
                <input class="post" type="text" name="del_year" value="{S_YEAR}" size="4" maxlength="4" />
            </td>
        </tr>
        <tr>
