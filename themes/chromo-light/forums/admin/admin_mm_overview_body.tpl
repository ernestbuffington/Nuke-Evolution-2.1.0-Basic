    ...
    <table width="100%" cellspacing="2" cellpadding="2"  align="center">
        <tr>
            <td align="center" nowrap="nowrap">
                <span class="genmed">
                    {L_MMO_CHOOSE}:&nbsp;{S_MODE_SELECT}&nbsp;&nbsp;{L_MMO_ORDER}&nbsp;{S_ORDER_SELECT}&nbsp;&nbsp;
                </span>
...
<!-- BEGIN mm_no_overview -->
        <tr>
            <td align="center" class="row1" colspan="8">
                <span class="gensmall">
                    {mm_no_overview.NO_OVERVIEW}
                </span>
            </td>
        </tr>
<!-- END mm_no_overview -->
<!-- BEGIN mm_overview -->
        <tr>
            <td align="center" class="row2">
                <span class="gensmall">
                    <strong>{mm_overview.MOVED_TYPE}</strong>
                </span>
            </td>
            <td align="center" class="row1">
                <span class="gensmall">
                    {mm_overview.MOVED_MOD}
                </span>
            </td>
            <td align="center" class="row2">
                <span class="gensmall">
                    {mm_overview.MOVED_TOPIC}
                </span>
            </td>
            <td align="center" class="row1">
                <span class="gensmall">
                    {mm_overview.MOVED_OLDTOPIC}
                </span>
            </td>
            <td align="center" class="row2">
                <span class="gensmall">
                    {mm_overview.MOVED_PARENT}
                </span>
            </td>
            <td align="center" class="row1">
                <span class="gensmall">
                    {mm_overview.MOVED_TARGET}
                </span>
            </td>
            <td align="center" class="row2">
                <span class="gensmall">
                    {mm_overview.MOVED_TIME}
                </span>
            </td>
            <td align="center" class="row1" align="center" valign="middle">
                <input type="checkbox" name="mmo_list[]" value="{mm_overview.MOVED_ID}" />
            </td>
        </tr>
<!-- END mm_overview -->
<!-- BEGIN mm_switch_markunmark -->
        <tr>
            <td class="catHead" colspan="8" height="28" align="right">
                <span class="gensmall">
                    <strong><a href="javascript:select(true);" class="gensmall">{L_MMO_MARK}</a>&nbsp;
                    <a href="javascript:select(false);" class="gensmall">{L_MMO_UNMARK}</a></strong>
                </span>
                &nbsp;&nbsp;
