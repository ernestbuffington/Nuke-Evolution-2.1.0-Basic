...
<!-- BEGIN record_row -->
        <tr>
            <td class="row2">
                <div align="center">{record_row.ID_LOG}</div>
            </td>
            <td class="row1">
                <div align="center">{record_row.ACTION}</div>
            </td>
            <td class="row2">
                <div align="center">{record_row.TOPIC}&nbsp;&nbsp;&nbsp;{record_row.TOPIC_IMG}</div>
            </td>
            <td class="row1">
                <div align="center">{record_row.USERNAME}</div>
            </td>
            <td class="row2">
                <div align="center"><a href="{record_row.U_WHOIS_IP}" target="_blank">{record_row.USER_IP}</a></div>
            </td>
            <td class="row1">
                <div align="center">{record_row.DATE}</div>
            </td>
            <td class="row2" align="center" valign="middle">
                <input type="checkbox" name="log_list[]" value="{record_row.ID_LOG}" />
            </td>
        </tr>
<!-- END record_row -->
        <tr>
        ...
        <tr>
            <td class="catBottom" colspan="9" height="28" align="right">
                <span class="gensmall">
                    <strong><a href="javascript:select(true);" class="gensmall">{L_MARK_ALL}</a>&nbsp;::&nbsp;
                    <a href="javascript:select(false);" class="gensmall">{L_UNMARK_ALL}</a></strong>
                </span>
            </td>
        </tr>
    </table>
