    ...
    <table width="99%" cellpadding="4" cellspacing="1"  align="center" class="forumline">
        ...
        <tr>
            ...
            <td class="row2" width="60%">
                <input type="text" class="post" name="new_main" size="64" value="{KEY_MAIN}" />
            </td>
        </tr>
        <tr>
            <td class="row1" width="40%">
            ...
            <td class="row2" width="60%">
                <input type="text" class="post" name="new_sub" size="64" value="{KEY_SUB}" />
            </td>
        </tr>
        <tr>
            <td class="row1" width="40%">
        ...
        <tr>
            ...
            <td class="row2" width="60%">
                <span class="gen">
                    <input type="radio" class="radio" name="new_level" value="{LEVEL_NORMAL}" {S_LEVEL_NORMAL} />{L_LEVEL_NORMAL}&nbsp;
                    <input type="radio" class="radio" name="new_level" value="{LEVEL_ADMIN}" {S_LEVEL_ADMIN} />{L_LEVEL_ADMIN}
                </span>
            </td>
        </tr>
        <tr>
...
<!-- BEGIN row -->
        <tr>
            ...
            <td class="row2">
                <textarea rows="8" cols="64" name="new_values[{row.COUNTRY}]" class="post">{row.VALUE}</textarea>
            </td>
        </tr>
<!-- END row -->
        <tr>
