...
<!-- BEGIN row -->
        <tr>
            <td class="{row.CLASS}">
                <a href="{row.U_PACK}" class="gen">{row.PACK}</a>
            </td>
            <td class="{row.CLASS}" nowrap="nowrap">
                <a href="{row.U_KEY}" class="gen">{row.KEY_MAIN}{row.KEY_SUB}</a>
                <span class="gen">
                    {row.STATUS}
                </span>
            </td>
            ...
            <td class="{row.CLASS}" align="center">
                <span class="gen">
                    {row.LEVEL}
                </span>
            </td>
