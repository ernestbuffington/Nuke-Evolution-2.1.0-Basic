...
<div id="board_{DHTML_ID}" {DHTML_DISPLAY}>
    <table width="99%" cellpadding="4" cellspacing="1"  align="center" class="forumline">
        <tr>
            <td class="row1">
                {L_DISABLE_PRIVATE_MESSAGING}
            </td>
            <td class="row2">
                <input type="radio" name="privmsg_disable" value="0" {S_PRIVMSG_ENABLED} />{L_ENABLED}&nbsp;
        ...
        <tr>
            ...
            <td class="row2">
                <input type="radio" name="welcome_pm" value="1" {S_WELCOME_PM_ENABLED} />{L_ENABLED}&nbsp;
                <input type="radio" name="welcome_pm" value="0" {S_WELCOME_PM_DISABLED} />{L_DISABLED}
            </td>
        </tr>
        <tr>
            <td class="row1">
                {L_PM_ALLOW_THRESHOLD}<br />
                <span class="gensmall">
                    {L_PM_ALLOW_TRHESHOLD_EXPLAIN}
                </span>
            </td>
            <td class="row2">
