...
<div id="board_{DHTML_ID}" {DHTML_DISPLAY}>
    <table width="99%" cellpadding="4" cellspacing="1"  align="center" class="forumline">
        ...
        <tr>
            ...
            <td class="row2">
                <input class="post" type="text" maxlength="255" name="cookie_name" value="{COOKIE_NAME}" />
            </td>
        </tr>
        <tr>
            <td class="row1">
        ...
        <tr>
            ...
            <td class="row2">
                <input type="radio" name="cookie_secure" value="0" {S_COOKIE_SECURE_DISABLED} />{L_DISABLED}&nbsp;
                <input type="radio" name="cookie_secure" value="1" {S_COOKIE_SECURE_ENABLED} />{L_ENABLED}
            </td>
        </tr>
        <tr>
            <td class="row1">
