...
<div id="board_{DHTML_ID}" {DHTML_DISPLAY}>
    <table width="99%" cellpadding="4" cellspacing="1"  align="center" class="forumline">
        ...
        <tr>
            ...
            <td class="row2">
                <input type="radio" name="use_dhtml" value="1" {DHTML_YES} />{L_YES}&nbsp;
                <input type="radio" name="use_dhtml" value="0" {DHTML_NO} />{L_NO}
            </td>
        </tr>
        <tr>
            <td class="row1">
            ...
            <td class="row2">
                <input type="radio" name="use_theme_style" value="1" {ADMIN_STYLE_THEME} />{L_YES}&nbsp;
                <input type="radio" name="use_theme_style" value="0" {ADMIN_STYLE_DEFAULT} />{L_NO}
            </td>
        </tr>
        <tr>
            <td class="row1">
            ...
            <td class="row2">
                <input type="radio" name="board_disable" value="1" {S_DISABLE_BOARD_YES} />{L_YES}&nbsp;
                <input type="radio" name="board_disable" value="0" {S_DISABLE_BOARD_NO} />{L_NO}
            </td>
        </tr>
        <tr>
            <td class="row1">
                {L_DISABLE_BOARD_ADMINVIEW}<br />
                <span class="gensmall">
                    {L_DISABLE_BOARD_ADMINVIEW_EXPLAIN}
                </span>
            </td>
            <td class="row2">
                <input type="radio" name="board_disable_adminview" value="1" {S_DISABLE_BOARD_ADMINVIEW_YES} />{L_YES}&nbsp;
                <input type="radio" name="board_disable_adminview" value="0" {S_DISABLE_BOARD_ADMINVIEW_NO} />{L_NO}
            </td>
        </tr>
        <tr>
            <td class="row1">
                {L_DISABLE_BOARD_MSG}<br />
                <span class="gensmall">
                    {L_DISABLE_BOARD_MSG_EXPLAIN}
                </span>
            </td>
            <td class="row2">
                <input class="post" type="text" maxlength="255" size="40" name="board_disable_msg" value="{DISABLE_BOARD_MSG}" />
                <input type="hidden" name="require_activation" value="{ACTIVATION_NONE}" />
            </td>
        </tr>
        <tr>
            <td class="row1">
                {L_BOARD_EMAIL_FORM}<br />
                <span class="gensmall">
                    {L_BOARD_EMAIL_FORM_EXPLAIN}
                </span>
            </td>
            <td class="row2">
                <input type="radio" name="board_email_form" value="1" {BOARD_EMAIL_FORM_ENABLE} />{L_ENABLED}&nbsp;
        ...
        <tr>
            <td class="row1">
                {L_GUEST_SECURITY_CODE}<br />
                <span class="gensmall">
                    {L_GUEST_SECURITY_CODE_EXPLAIN}
                </span>
            </td>
            <td class="row2">
                <input type="radio" name="board_disable_security_code" value="1" {GUEST_SECURITY_CODE_YES} />{L_YES}&nbsp;
                <input type="radio" name="board_disable_security_code" value="0" {GUEST_SECURITY_CODE_NO} />{L_NO}
            </td>
        </tr>
        <tr>
            <td class="row1">
                {L_MAX_LOGIN_ATTEMPTS}<br />
                <span class="gensmall">
...
<!-- Quick Search -->
        <tr>
            <td class="row1">
                {L_QUICK_SEARCH_ENABLE}<br />
                <span class="gensmall">
                    {L_QUICK_SEARCH_ENABLE_EXPLAIN}
                </span>
            </td>
            <td class="row2">
                <input type="radio" name="quick_search_enable" value="1" {S_QUICK_SEARCH_ENABLE_YES} />{L_YES}&nbsp;
                <input type="radio" name="quick_search_enable" value="0" {S_QUICK_SEARCH_ENABLE_NO} />{L_NO}
            </td>
        </tr>
        <tr>
            <td class="row1">
                {L_GUEST_SEARCH_SECURITY_CODE}<br />
                <span class="gensmall">
                    {L_GUEST_SEARCH_SECURITY_CODE_EXPLAIN}
                </span>
            </td>
            <td class="row2">
                <input type="radio" name="search_disable_security_code" value="1" {GUEST_SEARCH_SECURITY_CODE_YES} />{L_YES}&nbsp;
                <input type="radio" name="search_disable_security_code" value="0" {GUEST_SEARCH_SECURITY_CODE_NO} />{L_NO}
            </td>
        </tr>
        <tr>
            <td class="row1">
...
<!-- Start replacement - Advanced time management MOD -->
        <tr>
            ...
            <td class="row2" nowrap="nowrap">
                ...
                <input type="radio" name="default_time_mode" value="1" {TIME_MODE_MANUAL_DST_CHECKED} />
                    <span class="gen">
                        {L_YES}
                    </span>
                <input type="radio" name="default_time_mode" value="0" {TIME_MODE_MANUAL_CHECKED} />
                    <span class="gen">
                        {L_NO}
                    </span>
                <input type="radio" name="default_time_mode" value="2" {TIME_MODE_SERVER_SWITCH_CHECKED} />
                    <span class="gen">
                        {L_TIME_MODE_DST_SERVER}
                    </span>
                <br />
                <span class="gen">
                    {L_TIME_MODE_DST_TIME_LAG}:
                </span>
                <input type="text" name="default_dst_time_lag" value="{DST_TIME_LAG}" maxlength="3" size="3" class="post" />
                    <span class="gen">
                        {L_TIME_MODE_DST_MN}
                    </span>
                <br />
                <span class="gen">
                    {L_TIME_MODE_TIMEZONE}:
                </span>
                <span class="gensmall">
                    {TIMEZONE_SELECT}
                </span>
...
<!-- End replacement - Advanced time management MOD -->
        ...
        <tr>
            ...
            <td class="row2">
                <input type="radio" name="prune_enable" value="1" {PRUNE_YES} />{L_YES}&nbsp;
        ...
        <tr>
            ...
            <td class="row2">
                <input type="radio" name="report_email" value="1" {REPORT_EMAIL_YES} />{L_YES}&nbsp;
