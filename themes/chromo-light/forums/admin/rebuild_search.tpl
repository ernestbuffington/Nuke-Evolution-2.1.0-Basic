...
<!-- END start_select_input -->
        ...
        <tr>
            ...
            <td class="row2" align="left">
                <input type="radio" name="clear_search" value="0" {CLEAR_SEARCH_DISABLED} checked="checked" />
                <span class="gensmall">
                    {L_CLEAR_SEARCH_NO}
                </span>
                <br />
                <input type="radio" name="clear_search" value="1" {CLEAR_SEARCH_DISABLED} />
                <span class="gensmall">
                    {L_CLEAR_SEARCH_DELETE}
                </span>
                <br />
                <input type="radio" name="clear_search" value="2" {CLEAR_SEARCH_DISABLED} />
                <span class="gensmall">
                    {L_CLEAR_SEARCH_TRUNCATE}
                </span>
            </td>
        </tr>
        <tr>
