...
<table  cellpadding="4" cellspacing="1" width="100%" class="forumline">
    ...
    <tr>
        <td align="right" class="row1" valign="top">
            <span class="gen">
                <strong>{L_SUBJECT}:</strong>
            </span>
        </td>
        <td class="row2" colspan="2" valign="top">
           <input type="text" name="subject" size="45" maxlength="60" style="width:450px" tabindex="2" class="post" value="{ROPM_QUICK_REPLY.SUBJECT}" /><br />
        </td>
    </tr>
    <tr>
        <td align="right" class="row1" valign="top">
        ...
        <td class="row1" colspan="2" valign="top" style="padding-top: 0px; padding-bottom: 0px">
            <textarea name="message" style="width:450px; height: 140px;" rows="11" cols="40" tabindex="3" class="post" onselect="storeCaret(this);" onclick="storeCaret(this);" onkeyup="storeCaret(this);"></textarea><br />
<!-- BEGIN SMILIES -->
            <img src="{ROPM_QUICK_REPLY.SMILIES.URL}"  onmouseover="this.style.cursor='hand';" onclick="emoticon('{ROPM_QUICK_REPLY.SMILIES.CODE}');" alt="{ROPM_QUICK_REPLY.SMILIES.DESC}" title="{ROPM_QUICK_REPLY.SMILIES.DESC}" />
<!-- END SMILIES -->
            <input type='button' name='SmilesButt' class='liteoption'  value='{L_ALL_SMILIES}' onclick='openAllSmiles();' />
            <br />
