    ...
    <tr>
        <td>
            <table width="100%" cellspacing="0" cellpadding="0">
                <tr>
                    <td width="46" height="109">
                        <img src="themes/chromo-light/forums/images/over_01.jpg" alt="" width="46" height="109" />
                    </td>
                    <td width="45" height="109" style="background-image: url(themes/chromo-light/forums/images/over_02.jpg)">
                        <img src="{SPACER_IMG}" alt="" width="45" height="1" />
                    </td>
                    <td height="109" style="background-image: url(themes/chromo-light/forums/images/over_03_tile.jpg)">
                    ...
                    <td width="45" height="109" style="background-image: url(themes/chromo-light/forums/images/over_04.jpg)">
                        <img src="{SPACER_IMG}" alt="" width="45" height="1" />
                    </td>
                    <td width="46" height="109">
                        <img src="themes/chromo-light/forums/images/over_05.jpg" alt="" width="45" height="109" />
                    </td>
                </tr>
            </table>
        </td>
