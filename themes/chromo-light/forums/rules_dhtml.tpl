 		...
 		<td class="{faq_block.faq_row.ROW_CLASS}" align="left" valign="top">
 			...
 			<div id="faq_a_{faq_block.faq_row.U_FAQ_ID}" style="display:none;">
				<table class="bodyline" width="100%" cellspacing="1" cellpadding="3"  align="center">
					<tr>
						<td class="spaceRow"><img src="{SPACER}" alt="" width="0" height="0" /></td>
					</tr>
					<tr>
					    <td align="left" valign="top">
					        <div class="postbody">{faq_block.faq_row.FAQ_ANSWER}<br /></div>
					    </td>
					</tr>
					<tr>
						<td class="spaceRow"><img src="{SPACER}" alt="" width="0" height="0" /></td>
...
<table width="100%" cellspacing="2"  align="center">
	<tr>
		<td align="left" valign="middle" nowrap="nowrap">
		    <span class="copyright">DHTML Collapsible FAQ v1.0.0 &copy; 2004 by <a href="http://www.phpmix.com/" target="_blank" class="copyright">phpMiX</a></span>
		</td>
