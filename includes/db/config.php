...
----------------------------------------------------------------------*/
define ('KERNEL_STATUS_SAFEMODE', '0');
define ('KERNEL_STATUS_OPENBASEDIR', '0');
define ('KERNEL_STATUS_SESSIONSUPPORT', '1');
define ('KERNEL_STATUS_CURLSUPPORT', '1');
define ('KERNEL_STATUS_FILEUPLOAD', '1');
define ('KERNEL_STATUS_FILEUPLOADMAXSIZE', '20');
define ('KERNEL_STATUS_POSTMAXSIZE', '12');
define ('KERNEL_STATUS_GDSUPPORT', '1');
define ('KERNEL_STATUS_MAXMEMORY', '32');
