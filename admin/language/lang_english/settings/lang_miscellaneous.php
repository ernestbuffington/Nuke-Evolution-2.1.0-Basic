...
$lang_admin[$settingspoint]['MENU_TITLE'] = 'Enhanced Settings';
$lang_admin[$settingspoint]['SETTING_HEADER'] = 'Enhanced Website Settings';
$lang_admin[$settingspoint]['SETTING_FIELDSET'] = 'Enhanced Options';

$lang_admin[$settingspoint]['FIELD_HTTPREF_ON'] = 'Save references to your Website (HTTP Referrer)';
$lang_admin[$settingspoint]['FIELD_HTTPREF_ON_HELP'] = 'If set to yes, references to your website are saved in the database and shown in the referrer block and referrer administration. This function may slow down the website generation.';
$lang_admin[$settingspoint]['FIELD_HTTPREF_MAX'] = 'How many references should be stored';
$lang_admin[$settingspoint]['FIELD_HTTPREF_MAX_HELP'] = 'You can set the amount of referrers stored in the database. Default is 1000. Do not choose a much higher value.';
...
$lang_admin[$settingspoint]['FIELD_ACTIVATE_HEADLINES_HELP'] = 'Defines if registered users are allowed to set their individual RSS feed (headline) for their profile.'; 
...
$lang_admin[$settingspoint]['FIELD_ACTIVATE_COLORSUSE'] = 'Activate User- and Group colors';
...
$lang_admin[$settingspoint]['FIELD_TEXTEDITORS'] = 'Which Text editor should be used';
$lang_admin[$settingspoint]['FIELD_TEXTEDITORS_HELP'] = 'Choose the text editor for text input fields. A text editor must be installed in order to change this option from BBCode to a different WYSIWYG editor. This setting has no effect for the forums, as a special BBCode editor is build in the forums area.';

$lang_admin[$settingspoint]['OPTION_COLLAPSE_BLOCKS_ICON'] = 'Plus/Minus Symbol';
$lang_admin[$settingspoint]['OPTION_COLLAPSE_BLOCKS_TITLE'] = 'Title';
$lang_admin[$settingspoint]['OPTION_BLOCK_CACHETIME_DEACTIVATED'] = 'Cache deactivated';
$lang_admin[$settingspoint]['OPTION_BLOCK_CACHETIME_MINUTES'] = 'Minutes';
$lang_admin[$settingspoint]['OPTION_BLOCK_CACHETIME_HOURS'] = 'Hours';
$lang_admin[$settingspoint]['OPTION_LAZYTAP_DEACTIVATED'] = 'Deactivated';
$lang_admin[$settingspoint]['OPTION_LAZYTAP_BOTS'] = 'Only WebCrawler';
$lang_admin[$settingspoint]['OPTION_LAZYTAP_ALL'] = 'Everyone';
$lang_admin[$settingspoint]['OPTION_LAZYTAP_ADMINBOTS'] = 'For WebCrawler and Administrators';
$lang_admin[$settingspoint]['OPTION_TEXTEDITOR_NONE'] = 'None';

$lang_admin[$settingspoint]['INFO_ACTIVATE_ADMINSSL'] = 'SSL must be activated on our Server';
$lang_admin[$settingspoint]['INFO_ACTIVATE_BANNERS'] = 'Shows Banners created in Advertising Module';
...
// SexyTooltips
$lang_admin[$settingspoint]['HELP_SEXY_TOOLTIPS_LAYOUT'] = 'You can choose many layouts. Change the frame and background of your tool tip with only a few clicks.';
...
$lang_admin[$settingspoint]['SEXY_TOOLTIPS_BREAK'] = 'Tooltip Settings';
// done
?>