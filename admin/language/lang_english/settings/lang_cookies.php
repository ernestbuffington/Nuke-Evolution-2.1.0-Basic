...
$lang_admin[$settingspoint]['MENU_TITLE'] = 'Cookie Settings';
$lang_admin[$settingspoint]['SETTING_HEADER'] = 'Board Cookie Settings';
$lang_admin[$settingspoint]['SETTING_FIELDSET'] = 'Cookie Options';
...
$lang_admin[$settingspoint]['FIELD_COOKIE_LIFETIME'] = 'Time of Cookies';
...
$lang_admin[$settingspoint]['OPTION_COOKIE_LOGOUT'] = 'Logout when windows close';
$lang_admin[$settingspoint]['OPTION_COOKIE_BLOCK'] = 'Block Logins';
$lang_admin[$settingspoint]['OPTION_COOKIE_SECONDS'] = 'Seconds';
...
$lang_admin[$settingspoint]['OPTION_COOKIE_DAY'] = 'Day';
$lang_admin[$settingspoint]['OPTION_COOKIE_DAYS'] = 'Days';
$lang_admin[$settingspoint]['OPTION_COOKIE_WEEK'] = 'Week';
$lang_admin[$settingspoint]['OPTION_COOKIE_WEEKS'] = 'Weeks';
$lang_admin[$settingspoint]['OPTION_COOKIE_MONTH'] = 'Month';
$lang_admin[$settingspoint]['OPTION_COOKIE_MONTHS'] = 'Months';
$lang_admin[$settingspoint]['OPTION_COOKIE_INDEFINITE'] = 'Indefinite';
$lang_admin[$settingspoint]['OPTION_COOKIE_AUTOMATIC'] = 'Auto logout in first pageview';
