...
if (is_admin()) {
    ...
    switch ($op) {
        ...
        case 'ABImport':                include(NUKE_ADMIN_MODULE_DIR.'nukesentinel/ABImport.php');break;
        case 'ABImportBlockedRange':    include(NUKE_ADMIN_MODULE_DIR.'nukesentinel/ABImportBlockedRange.php');break;
        case 'ABImportIP2Country':      include(NUKE_ADMIN_MODULE_DIR.'nukesentinel/ABImportIP2Country.php');break;
