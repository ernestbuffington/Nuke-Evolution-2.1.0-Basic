...
global $evoconfig, $admin_file, $db, $_GETVAR, $bgcolor2, $bgcolor1;

if (is_admin() ) {

    $tip = $_GETVAR->get('tip', '_REQUEST', 'array');
    ...
    echo '<tr><td bgcolor="'.$bgcolor2.'"><strong>'._AB_USERNAME.':</strong></td><td><input type="text" name="xusername" size="20" value="'.$evoconfig['anonymous'].'" /></td></tr>'."\n";
