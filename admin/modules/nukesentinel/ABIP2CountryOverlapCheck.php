...
if (is_admin()) {
    ...
    $perpage = 100;
    $totalselected = $db->sql_unumrows("SELECT `ip_lo` FROM `"._SENTINEL_IP2COUNTRY_TABLE."`");
    if ($min == 0) {
        ...
        OpenTable();
        $testmessage = "";
        $result = $db->sql_query("SELECT `ip_lo`, `ip_hi` FROM `"._SENTINEL_IP2COUNTRY_TABLE."` ORDER BY ip_lo LIMIT $min, $perpage");
        while(list($xip_lo, $xip_hi) = $db->sql_fetchrow($result)) {
            $test1 = $db->sql_query("SELECT * FROM "._SENTINEL_IP2COUNTRY_TABLE." WHERE (ip_lo<='$xip_lo' AND ip_hi>='$xip_lo') AND (`ip_lo`!='$xip_lo' AND `ip_hi`!='$xip_hi') ORDER BY `ip_lo`");
            $test2 = $db->sql_query("SELECT * FROM "._SENTINEL_IP2COUNTRY_TABLE." WHERE (ip_lo<='$xip_hi' AND ip_hi>='$xip_hi') AND (`ip_lo`!='$xip_lo' AND `ip_hi`!='$xip_hi') ORDER BY `ip_lo`");
            $test3 = $db->sql_query("SELECT * FROM "._SENTINEL_IP2COUNTRY_TABLE." WHERE (ip_lo>='$xip_lo' AND ip_hi<='$xip_hi') AND (`ip_lo`!='$xip_lo' AND `ip_hi`!='$xip_hi') ORDER BY `ip_lo`");
            $test4 = $db->sql_query("SELECT * FROM "._SENTINEL_IP2COUNTRY_TABLE." WHERE (ip_lo<='$xip_lo' AND ip_hi>='$xip_hi') AND (`ip_lo`!='$xip_lo' AND `ip_hi`!='$xip_hi') ORDER BY `ip_lo`");
            ...
            if($testnum1 > 0) {
                ...
                while($testrow1 = $db->sql_fetchrow($test1)) {
                    ...
                    $testmessage .= '<td align="center" nowrap="nowrap">&nbsp;<a href="'.$admin_file.'.php?op=ABIP2CountryEdit&amp;ip_lo='.$testrow1['ip_lo'].'&amp;ip_hi='.$testrow1['ip_hi'].'&amp;xop='.$op.'&amp;min=1" ><img src="images/nukesentinel/edit.png" border="0" alt="'._AB_EDIT.'" title="'._AB_EDIT.'" height="16" width="16" /></a>'."\n";
                    $testmessage .= '<a href="'.$admin_file.'.php?op=ABIP2CountryDelete&amp;ip_lo='.$testrow1['ip_lo'].'&amp;ip_hi='.$testrow1['ip_hi'].'&amp;xop='.$op.'&amp;min=1" ><img src="images/nukesentinel/delete.png" border="0" alt="'._AB_DELETE.'" title="'._AB_DELETE.'" height="16" width="16" /></a>&nbsp;</td>'."\n";
                    $testmessage .= '</tr>'."\n";
                }
            ...
            if($testnum2 > 0) {
                ...
                while($testrow2 = $db->sql_fetchrow($test2)) {
                    ...
                    $testmessage .= '<td align="center" nowrap="nowrap">&nbsp;<a href="'.$admin_file.'.php?op=ABIP2CountryEdit&amp;ip_lo='.$testrow2['ip_lo'].'&amp;ip_hi='.$testrow2['ip_hi'].'&amp;xop='.$op.'&amp;min=1" ><img src="images/nukesentinel/edit.png" border="0" alt="'._AB_EDIT.'" title="'._AB_EDIT.'" height="16" width="16" /></a>'."\n";
                    $testmessage .= '<a href="'.$admin_file.'.php?op=ABIP2CountryDelete&amp;ip_lo='.$testrow2['ip_lo'].'&amp;ip_hi='.$testrow2['ip_hi'].'&amp;xop='.$op.'&amp;min=1" ><img src="images/nukesentinel/delete.png" border="0" alt="'._AB_DELETE.'" title="'._AB_DELETE.'" height="16" width="16" /></a>&nbsp;</td>'."\n";
                    $testmessage .= '</tr>'."\n";
                }
            ...
            if($testnum3 > 0) {
                ...
                while($testrow3 = $db->sql_fetchrow($test3)) {
                    ...
                    $testmessage .= '<td align="center" nowrap="nowrap">&nbsp;<a href="'.$admin_file.'.php?op=ABIP2CountryEdit&amp;ip_lo='.$testrow3['ip_lo'].'&amp;ip_hi='.$testrow3['ip_hi'].'&amp;xop='.$op.'&amp;min=1" ><img src="images/nukesentinel/edit.png" border="0" alt="'._AB_EDIT.'" title="'._AB_EDIT.'" height="16" width="16" /></a>'."\n";
                    $testmessage .= '<a href="'.$admin_file.'.php?op=ABIP2CountryDelete&amp;ip_lo='.$testrow3['ip_lo'].'&amp;ip_hi='.$testrow3['ip_hi'].'&amp;xop='.$op.'&amp;min=1" ><img src="images/nukesentinel/delete.png" border="0" alt="'._AB_DELETE.'" title="'._AB_DELETE.'" height="16" width="16" /></a>&nbsp;</td>'."\n";
                    $testmessage .= '</tr>'."\n";
                }
            ...
            if($testnum4 > 0) {
                ...
                while($testrow4 = $db->sql_fetchrow($test4)) {
                    ...
                    $testmessage .= '<td align="center" nowrap="nowrap">&nbsp;<a href="'.$admin_file.'.php?op=ABIP2CountryEdit&amp;ip_lo='.$testrow4['ip_lo'].'&amp;ip_hi='.$testrow4['ip_hi'].'&amp;xop='.$op.'&amp;min=1" ><img src="images/nukesentinel/edit.png" border="0" alt="'._AB_EDIT.'" title="'._AB_EDIT.'" height="16" width="16" /></a>'."\n";
                    $testmessage .= '<a href="'.$admin_file.'.php?op=ABIP2CountryDelete&amp;ip_lo='.$testrow4['ip_lo'].'&amp;ip_hi='.$testrow4['ip_hi'].'&amp;xop='.$op.'&amp;min=1"><img src="images/nukesentinel/delete.png" border="0" alt="'._AB_DELETE.'" title="'._AB_DELETE.'" height="16" width="16" /></a>&nbsp;</td>'."\n";
                    $testmessage .= '</tr>'."\n";
                }
