...
if (is_god_admin() || is_admin('super')) {
    ...
    if ($adminsetmenu == 1) {
        ...
        $menupoint[$settingspoint]['menuimage'] = 'adm_tos.png';
        return;
    }
    ...
    $fieldset = array(
            'tos' => array(
                'input_order'       => 1,
                'input_text'        => $lang_admin[$settingspoint]['FIELD_TOS'],
                'input_type'        => 'yesno',
                'check_type'        => 'int',
                'check_special'     => '',
                'input_name'        => 'tos',
            ...
            'tosall' => array(
                'input_order'       => 2,
                'input_text'        => $lang_admin[$settingspoint]['FIELD_TOSALL'],
                'input_type'        => 'yesno',
                'check_type'        => 'int',
                'check_special'     => '',
                'input_name'        => 'tosall',
            ...
            'tos_text' => array(
                'input_order'       => 3,
                'input_text'        => $lang_admin[$settingspoint]['FIELD_TOSTEXT'],
                'input_type'        => 'textarea',
                'check_type'        => 'string',
                'check_special'     => '',
                'input_name'        => 'tos_text',
