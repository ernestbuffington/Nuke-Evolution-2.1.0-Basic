...
if (is_god_admin() || is_admin('super')) {
    ...
    if ($adminsetmenu == 1) {
        ...
        $menupoint[$settingspoint]['menuimage'] = 'adm_jug.png';
        return;
    }
    ...
    $fieldset = array(
            'coppa' => array(
                'input_order'       => 1,
                'input_text'        => $lang_admin[$settingspoint]['FIELD_COPPA'],
                'input_type'        => 'yesno',
                'check_type'        => 'int',
                'check_special'     => '',
                'input_name'        => 'coppa',
    ...
    while ($i <= 30) {
        $coppatemp[$j] = array(
            'input_text'  => $i. '&nbsp;'. $lang_admin[$settingspoint]['OPTION_COPPA_AGE'],
            'input_value' => $i,
        );
        $i++;
        $j++;
    }
    $fieldset ['coppa_age'] = array(
                'input_order'       => 2,
                'input_text'        => $lang_admin[$settingspoint]['FIELD_COPPAAGE'],
                'input_type'        => 'option',
                'input_option'       => $coppatemp,
                'check_type'        => 'int',
                'check_special'     => '',
                'input_name'        => 'coppa_age',
                'input_size'        => 0,
                'input_maxlength'   => 0,
                'input_readonly'    => FALSE,
                'input_checked'     => FALSE,
                'input_disabled'    => FALSE,
                'input_value'       => 'coppa_age',
                'input_help'        => FALSE,
                'input_additional'  => '',
                'db_table'          => '_CNBYA_CONFIG_TABLE',
                'db_valuefield'     => 'config_value',
    ...
    $fieldset ['coppa_text'] = array(
                'input_order'       => 3,
                'input_text'        => $lang_admin[$settingspoint]['FIELD_COPPATEXT'],
                'input_type'        => 'textarea',
                'check_type'        => 'string',
                'check_special'     => '',
                'input_name'        => 'coppa_text',
                'input_size'        => 100,
                'input_maxlength'   => 150,
                'input_readonly'    => FALSE,
                'input_checked'     => FALSE,
                'input_disabled'    => FALSE,
                'input_value'       => 'coppa_text',
                'input_help'        => FALSE,
                'input_additional'  => '',
                'db_table'          => '_CNBYA_CONFIG_TABLE',
                'db_valuefield'     => 'config_value',
