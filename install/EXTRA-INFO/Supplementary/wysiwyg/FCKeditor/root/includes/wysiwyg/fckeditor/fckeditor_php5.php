...
class FCKeditor
{
	 ...
	 */
	public function __construct( $instanceName, $width='100%', $height='400px', $value='' )
 	{
		$this->InstanceName	= $instanceName ;
		$this->BasePath		= 'includes/wysiwyg/fckeditor/' ;
		$this->Width		= $width;
		$this->Height		= $height;
	...
	// PHP 5 Contructor
	function FCKeditor($instanceName, $width='100%', $height='400px', $value='')
	{
		$this->__construct( $instanceName, $width, $height, $value ) ;
	}
