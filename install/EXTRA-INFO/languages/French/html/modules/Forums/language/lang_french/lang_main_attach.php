...
$lang['Extension_disabled_after_posting'] = 'L\'extension \'%s\' a &eacute;t&eacute; d&eacute;sactiv&eacute;e par le webmaster, par cons&eacute;quent ce fichier ne peut-&eacute;tre affich&eacute;.'; // used in Posts and PM's, replace %s with mime type

// Posting/PM -> Initial Display
$lang['Attach_posting_cp'] = 'Panneau de Contr&ocirc;le des fichiers joints';
$lang['Attach_posting_cp_explain'] = 'Si vous cliquez sur <u>Joindre un fichier</u>, vous apercevrez une bo&icirc;te de dialogue pour joindre des fichiers.<br />Si vous cliquez sur <u>Fichiers envoy&eacute;s</u>, vous apercevrez une liste des fichiers d&eacute;j&agrave; joints et vous pourrez les &eacute;diter.<br />Si vous souhaitez remplacer un fichier joint (<u>Envoyer une nouvelle version</u>), vous devrez cliquer sur ces deux liens. Joignez le fichier comme vous le feriez normalement, par la suite ne cliquez surtout pas sur <u>Joindre un fichier</u>, cliquez plut&ocirc;t sur <u>Envoyer une nouvelle version</u> en face du fichier que vous souhaitez mettre &agrave; jour.';
...
$lang['Posted_attachments'] = 'Fichiers envoy&eacute;s';
...
$lang['Disallowed_extension_within_forum'] = 'Vous n\'&eacute;tes pas autoris&eacute; &agrave; joindre des fichiers avec l\'extension %s dans ce forum'; // replace %s with the Extension
...
$lang['Too_many_attachments'] = 'Ce fichier ne peut-&eacute;tre ajout&eacute; car le nombre maximum de %d fichiers joints dans ce message a &eacute;t&eacute; atteint'; // replace %d with maximum number of attachments
$lang['Error_imagesize'] = 'L\'image jointe doit-&eacute;tre inf&eacute;rieure &agrave;: %d x %d (largeur x Hauteur en pixels)';
...
// Errors -> PM Related
$lang['Attach_quota_sender_pm_reached'] = 'D&eacute;sol&eacute;, mais la taille maximale pour l\'ensemble des fichiers joints dans votre Bo&icirc;te des Messages Priv&eacute;s a &eacute;t&eacute; atteinte. Veuillez supprimer quelques-uns de vos fichiers reçus ou envoy&eacute;s.';
$lang['Attach_quota_receiver_pm_reached'] = 'D&eacute;sol&eacute;, mais la taille maximale pour l\'ensemble des fichiers joints dans la Bo&icirc;te des Messages Priv&eacute;s de \'%s\' a &eacute;t&eacute; atteinte. Veuillez le-lui faire savoir, ou attendez jusqu\'&agrave; ce qu\'il/elle ait supprim&eacute; quelques-uns de ses fichiers joints.';
...
// Delete Attachments
$lang['Confirm_delete_attachments'] = 'Etes vous s&ucirc;r de vouloir supprimer les fichiers s&eacute;lectionn&eacute;s ?';
...
$lang['Confirm_delete_pm_attachments'] = 'Etes vous s&ucirc;r de vouloir supprimer tous les fichiers joints dans ce Message Priv&eacute; ?';

// General Error Messages
$lang['Attachment_feature_disabled'] = 'La fonction fichier joint est d&eacute;sactiv&eacute;e.';

$lang['Directory_does_not_exist'] = 'Le r&eacute;pertoire \'%s\' n\'existe pas ou ne peut pas &eacute;tre trouv&eacute;.'; // replace %s with directory
...
$lang['Ftp_error_delete'] = 'Impossible de supprimer les fichers du r&eacute;pertoire FTP: \'%s\'. Veuillez v&eacute;rifier vos param&egrave;tres FTP.<br />Une autre raison pour cette erreur pourrait-&eacute;tre la non existence du fichier joint, veuillez v&eacute;rifier d\'abord dans les fichiers joints perdus.';
...
$lang['Note_user_empty_group_permissions'] = 'NOTE:<br />Normalement, vous &eacute;tes autoris&eacute; &agrave; joindre des fichiers dans ce forum, <br />mais tant qu\'aucun groupe d\'extensions n\'est autoris&eacute; &agrave; &eacute;tre joint ici, <br />vous ne pouvez joindre aucun fichier. Si vous essayez, <br />vous aurez un message d\'erreur.<br />';
...
$lang['UACP'] = 'Panneau de Contr&ocirc;le des Attachements de l\'utilisateur';
$lang['User_uploaded_profile'] = 'T&eacute;l&eacute;charger: %s';
...
$lang['Attachbox_limit'] = 'Votre Bo&icirc;te d\'Attache est pleine &agrave; %d%%';
