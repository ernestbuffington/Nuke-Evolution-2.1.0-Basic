...
$lang_new[$module_name]['HELLO'] = 'Merhaba ';
$lang_new[$module_name]['PRIVMSG_CLICK']   = 'Özel Mesajınızı okumak için: <a href="' . EVO_SERVER_URL .'/modules.php?name=Private_Messages&amp;folder=inbox">-Mesajı Görüntüle-</a> linkini tıklayın';
...
$lang_new[$module_name]['PRIVMSG_SUBJECT'] = 'Sitemiz '.$board_config['sitename'].' de Sizi Bekleyen yeni Mesajınız var';
