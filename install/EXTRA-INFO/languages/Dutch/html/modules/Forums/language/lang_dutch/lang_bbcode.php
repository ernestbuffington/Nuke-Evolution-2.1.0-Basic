...
/*****[BEGIN]******************************************
 [ Mod:     PHP Syntax Highlighter BBCode      v3.0.3 ]
 ******************************************************/
$faq[] = array('Wat is al die larie over PHP!?', 'De PHP BBcode is eigen aan de BBcode, uitsluitend dat het alleen moet gebruik worden voor PHP code.  Waarom?  Omdat bepaalde secties van de PHP code worden opgelicht maakt dit het gemakkelijker om te lezen.');
/*****[END]********************************************
 [ Mod:     PHP Syntax Highlighter BBCode      v3.0.3 ]
 ******************************************************/
