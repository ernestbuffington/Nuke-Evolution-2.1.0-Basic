...
define("_WHOSONLINE","Quién está en línea");
define("_PRODUCTTITLE","Título del Producto");
define("_RELATEDLINK","Enlaces relacionados");
define("_LINKTITLE","Título del enlace");
define("_REVIEWER","Revisor:");
define("_REVIEWID","Revisión ID");
define("_HITS","Aciertos");
define("_THEREARE","Hay");
define("_REVIEWS","Revisiones");
define("_ARTICLES","Artículos");
define("_ALL","Todo");
define("_PAGEBREAK","Si quiere varias páginas, puede escribir <strong>&lt;!--salto de página--&gt;</strong> donde quieras cortar.");
define("_DONTSELECT","Nota: no seleccione cualquier sección para almacenar el texto y publicarla más tarde.");
define("_AREYOUSURE","Confirma que ha incluido una dirección URL? Probarlas para errores tipográficos");
define("_SELECTTOPIC","Seleccione el tema");
define("_PREVIEW","Vista previa");
define("_ICQ","ICQ Número");
define("_AIM","AIM Número");
define("_YIM","YIM Número");
define("_MSNM","MSNM Número");
define("_LOCATION","Ubicación");
define("_OCCUPATION","Occupacion");
define("_INTERESTS","Intereses");
define("_SIGNATURE","Firma");
define("_EXTRAINFO","Información adicional");
define("_OPTION","Opcion");
define("_YOUARELOGGEDOUT","Has terminado tu sesión!");
define("_HOMECONFIG","Inicio Configuración");
define("_CHECK","Comprobar");
...
define("_HOMEPAGE","Página principal");
define("_THUMBNAIL","Miniatura");
define("_NAME","Nombre");
define("_FILEURL","Enlace de archivos");
define("_DOWNLOADID","Descarga ID");
define("_FROM","Desde");
define("_DATE","Fecha");
define("_TO","Para");
...
define("_ADDURL","Agregar esta URL");
define("_SHOW","Mostrar");
define("_DAYS","dias");
define("_STAFF","Personal");
define("_LINKID","Enlace ID");
define("_ADMINID","Administrador ID");
define("_ADMINLOGIN","Sistema de Administración de inicio de sesión");
define("_FAQ","FAQ");
...
define("_ADMPOLLS","Encuestas/Encuestas");
define("_SECTIONSMANAGER","Secciones");
define("_ADDSTORY","Agregar la historia");
define("_EDITUSERS","Editar usuarios");
define("_ADMINMENU","Menú de administración");
define("_BANNERSADMIN","Administración de Banner");
define("_ONLINEMANUAL","Manual en línea");
define("_ADMINLOGOUT","Desconetarse / Salir");
define("_LAST","Último");
define("_GO","Ir!");
define("_CURRENTPOLL","Encuesta Actual");
define("_STORYID","Historia ID");
define("_BANNERS_ADMIN_HEADER", "Nuke-Evolution Banners :: Panel de administración de módulos");
define("_BANNERS_RETURNMAIN", "Volver a la Administración principal");
define("_ACTIVEBANNERS","Activo actual Banners");
define("_ACTIVEBANNERS2","Activo Banners");
define("_IMPRESSIONS","Impresiones");
define("_IMPLEFT","Imp. Izquierdo");
define("_CLICKS","Haga clic en");
define("_CLICKSPERCENT","% Haga clic en");
define("_CLIENTNAME","Nombre del Cliente");
define("_FINISHEDBANNERS","Terminado Banners");
define("_IMP","Imp.");
define("_DATESTARTED","Fecha de inicio");
define("_DATEENDED","Fecha de finalización");
define("_ADVERTISINGCLIENTS","Publicidad Clientes");
define("_CONTACTNAME","Nombre de Contacto");
define("_CONTACTEMAIL","E-mail de contacto");
define("_ADDNEWBANNER","Agregar un nuevo Banner");
define("_PURCHASEDIMPRESSIONS","Compró Impresiones");
define("_IMAGEURL","Imagen URL");
define("_CLICKURL","Haga clic en URL");
define("_ADDBANNER","Agregar Banner");
define("_ADDCLIENT","Agregar un nuevo cliente");
define("_CLIENTLOGIN","Inicio de sesión de cliente");
define("_CLIENTPASSWD","Contraseña del cliente");
define("_ADDCLIENT2","Agregar cliente");
define("_BANNERSNOTACTIVE","Banners variable en config.php archivo es 0, esto significa que usted no puede ver su banners hasta que activarlo.");
define("_TOACTIVATE","Para ello, basta con cambiar el valor de <a href=\"$admin_file?op=Configure#banners\">Ajustes de la sección</a>.");
define("_IMPORTANTNOTE","Nota importante!");
define("_DELETEBANNER","Borrar Banner");
define("_SURETODELBANNER","Estás seguro de que deseas eliminar este Banner?");
define("_EDITBANNER","Editar Banner");
define("_ADDIMPRESSIONS","Agregar más impresiones");
define("_PURCHASED","Comprado");
define("_MADE","Hecho");
define("_DELETECLIENT","Eliminar la publicidad de clientes");
define("_SURETODELCLIENT","Estás a punto de eliminar el cliente y todos sus Banners!!!");
define("_CLIENTWITHOUTBANNERS","Este cliente no tiene ninguna bandera ejecutando ahora.");
define("_DELCLIENTHASBANNERS","Este cliente tiene las siguientes ACTIVO BANNERS ejecutando actualmente");
define("_EDITCLIENT","Editar la publicidad de clientes");
define("_REMOVECOMMENTS","Eliminar Comentario");
define("_SURETODELCOMMENTS","Estás seguro de que deseas eliminar, seleccione el comentario y todas sus respuestas?");
define("_BLOCKSADMIN","Administración de Bloques");
define("_BLOCKS","Bloques");
define("_BLOCKSSHOW","Bloques Visible");
define("_TITLE","Titulo");
define("_POSITION","Posicion");
define("_WEIGHT","Peso");
define("_STATUS","Estado");
define("_LEFTBLOCK","<strong>Bloque de Izquierda</strong>");
...
define("_MODULESACTIVATION","See your Modules/Addons current status and change it by Activating or Deactivating them.<br />New Modules copied on the <em>/modules/</em> directory will be automaticaly added with <em>Inactive</em> status to the database when you reload this page.<br />If you want to remove a module just delete it from the <em>/modules/</em> directory, the system will automaticaly update your database to show the changes.");
...
define("_MODULEHOMENOTE","<strong>-= WARNING =-</strong><br />Bold module's title represents the module you have in the Homepage.<br />You can't Deactivate or Restrict this module while it's the default one!<br />If you delete the module's directory you'll see and error in the Homepage.<br />Also, this module has been replaced with <em>Home</em> link in the modules block.");
...
define("_POINTS14","Visit to a Web Link");
define("_DESC14","Each time a user clicks to visit any resource on Web Links module");
define("_POINTS15","Rate to any Web Link");
define("_DESC15","Each time a user votes for a resource in Web Links module");
define("_POINTS16","Comment to any Web Link");
define("_DESC16","Comments posted on any resource in the Web Links module");
