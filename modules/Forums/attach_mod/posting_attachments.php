    ...
    */
    function display_attachment_bodies() {
        ...
        $template->assign_vars(array(
            ...
            'RULES'                         => '<a href="' . append_sid("attach_rules.php?f=$u_rules_id") . '" onclick="window.open(this.href,\'_blank\'); return false;">' . $lang['Allowed_extensions_and_sizes'] . '</a>',
            'S_HIDDEN'                      => $s_hidden)
        );
        $attachments = array();
