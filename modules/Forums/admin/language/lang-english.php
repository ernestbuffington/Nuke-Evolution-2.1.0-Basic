...
define('_NLUNSUBSCRIBE','=========================================================\nYou\'re receiving this Newsletter because you selected to receive it from your user page at '.EVO_SERVER_SITENAME.'.\nYou can unsubscribe from this service by clicking in the following URL:\n\n'.EVO_SERVER_URL.'/modules.php?name=Your_Account&op=edituser\'\n\nthen select \'No\' from the option to Receive Newsletter by Email and save your changes, if you need more assistance please contact '.EVO_SERVER_SITENAME.' administrator.');
...
define('_MASSEMAILMSG','=========================================================\nYou\'re receiving this email because you\'re a registered user of '.EVO_SERVER_SITENAME.'. We hope that this email didn\'t disturbed you and in some manner contributes to improve our services.');
