...
// Configuration
//
$lang['Config_Stat_explain'] = 'Here you are able to configure the Statistics Mod.';
$lang['Config_Stat_title'] = 'Statistics Configuration';
...
$lang['Msg_reset_view_count'] = '- View Count successfully reset.';
...
$lang['Update_time_explain'] = 'Time Interval (in Minutes) of refreshing the cached data with new Data. Every x Minutes the Module get reloaded.<br />Since the Statistics is using an priority system, this could be greater than x minutes, but not more than one day.';
//
// Permissions
//
...
$lang['Language_cp_explain'] = 'Here you are able to manage all Language Variables and Language Packs for every Module, separate, at all... nearly everything. You are able to Import or Export Language Packs here too.';
...
$lang['No_package_Up'] = 'Found no files to package up. Info/Lang/PHP Files have to be placed into \'modules/pakfiles\'.';
