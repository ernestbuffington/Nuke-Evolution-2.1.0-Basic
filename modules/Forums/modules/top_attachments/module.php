...
for ($i = 0; $i < $num_attachments; $i++) {
    ...
    $view_attachment = append_sid('download.php?id=' . $attachments[$i]['attach_id']);
    ...
    $view_topic = append_sid('viewtopic.php?' . POST_POST_URL . '=' . intval($attachments[$i]['post_id']) . '#' . intval($attachments[$i]['post_id']));
