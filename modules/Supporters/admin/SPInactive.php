...
$pagetitle = ': '.$lang_new[$module_name]['SP_ADMINMAIN'].' - '.$lang_new[$module_name]['SP_INACTIVESITES'];
...
CloseTable();
echo "<br />";
title($lang_new[$module_name]['SP_ADMINMAIN'].' - '.$lang_new[$module_name]['SP_INACTIVESITES']);
spmenu();
echo "<br />\n";
OpenTable();
$a = 0;
...
if($numrows > 0) {
    ...
    while($site_row = $db->sql_fetchrow($result)) {
        ...
        echo " <a href='".$admin_file.".php?op=SPActivate&amp;site_id=".$site_row['site_id']."&amp;comefrom=SPInactive'><img src='".evo_image('activate.png', $module_name)."' width='16' height='16' border='0' alt='".$lang_new[$module_name]['SP_ACTIVATE']."' title='".$lang_new[$module_name]['SP_ACTIVATE']."' /></a>";
        echo " <a href='".$admin_file.".php?op=SPEdit&amp;site_id=".$site_row['site_id']."&amp;comefrom=SPInactive'><img src='".evo_image('edit.png', $module_name)."' width='16' height='16' border='0' alt='"._EDIT."' title='"._EDIT."' /></a>";
        echo " <a href='".$admin_file.".php?op=SPDelete&amp;site_id=".$site_row['site_id']."&amp;comefrom=SPInactive'><img src='".evo_image('delete.png', $module_name)."' width='16' height='16' border='0' alt='"._DELETE."' title='"._DELETE."' /></a>";
        echo "</td></tr>";
        echo "</table>";
        CloseTable();
        echo "</td>";
    ...
    echo "<center class='title'>".$lang_new[$module_name]['SP_NOINACTIVESITES']."</center>\n";
}
CloseTable();
