...
echo "<form method=\"post\" action=\"".$admin_file.".php\" name=\"reviewsettings\">";
/* General reviews settings */
$resultadmin = $db->sql_query("SELECT * FROM `" . _REVIEWS_CONFIG_TABLE . "`");
...
echo "<tr><td width=\"60%\" align=\"left\">". $lang_new[$module_name]['ADMIN_SETTING_GENERAL_REVIEWS_PER_PAGE'] ."</td><td width=\"10%\"></td><td></td><td><input type='text' name='reviews_perpage' value='". $row['reviews_perpage'] ."' size='2' maxlength='2' /></td></tr>\n";
echo "<tr><td width=\"60%\" align=\"left\">". $lang_new[$module_name]['ADMIN_SETTING_GENERAL_NO_NEWREVIEWS'] ."</td><td width=\"10%\"></td><td></td><td><input type='text' name='newreviews' value='". $row['newreviews'] ."' size='2' maxlength='2' /></td></tr>\n";
echo "<tr><td width=\"60%\" align=\"left\">". $lang_new[$module_name]['ADMIN_SETTING_GENERAL_NO_BESTREVIEWS'] ."</td><td width=\"10%\"></td><td></td><td><input type='text' name='topreviews' value='". $row['topreviews'] ."' size='2' maxlength='2' /></td></tr>\n";
echo "<tr><td width=\"60%\" align=\"left\">". $lang_new[$module_name]['ADMIN_SETTING_GENERAL_NO_SEARCHREVIEWS'] ."</td><td width=\"10%\"></td><td></td><td><input type='text' name='reviewsresults' value='". $row['reviewsresults'] ."' size='2' maxlength='2' /></td></tr>\n";
...
echo "</td></tr>";
echo "<tr><td width=\"60%\" align=\"left\">". $lang_new[$module_name]['ADMIN_SETTING_GENERAL_NO_UNKNOWNREVIEWS'] ."</td><td width=\"10%\"></td><td></td><td>";
echo yesno_option('anonaddreviewlock', $row['anonaddreviewlock']);
echo "</td></tr>";
...
echo "</td></tr>\n";
/* How many reviews */
echo "<tr><td width=\"60%\" align=\"left\">". $lang_new[$module_name]['ADMIN_SETTING_TOPBOX_SHOW_REVIEWS'] ."</td><td width=\"10%\"></td><td></td><td><input type='text' name='maxshow' value='". $row['maxshow'] ."' size='2' maxLength='2' /></td></tr>\n";
/* table colors*/
...
echo "<tr><td width=\"60%\" align=\"left\">". $lang_new[$module_name]['ADMIN_SETTING_GENERAL_NO_ADMINREVIEWS'] ."</td><td width=\"10%\"></td><td></td><td>";
...
echo "<tr><td width=\"60%\" align=\"left\">". $lang_new[$module_name]['ADMIN_SETTING_GENERAL_TOPREVIEWS_PERCENT'] ."</td><td width=\"10%\"></td><td></td><td>";
echo yesno_option('topreviewspercentrigger', $row['topreviewspercentrigger']);
echo "</td></tr>";
echo "<tr><td width=\"60%\" align=\"left\">". $lang_new[$module_name]['ADMIN_SETTING_GENERAL_TOPREVIEWS_VOTEMIN'] ."</td><td width=\"10%\"></td><td></td><td><input type='text' name='reviewvotemin' value='". $row['reviewvotemin'] ."' size='4' maxlength='4' /></td></tr>\n";
echo "<tr><td width=\"60%\" align=\"left\">". $lang_new[$module_name]['ADMIN_SETTING_GENERAL_POPULAR_PERCENT'] ."</td><td width=\"10%\"></td><td></td><td>";
echo yesno_option('mostpopreviewspercentrigger', $row['mostpopreviewspercentrigger']);
echo "</td></tr>";
echo "<tr><td width=\"60%\" align=\"left\">". $lang_new[$module_name]['ADMIN_SETTING_GENERAL_POPULAR_VOTEMIN'] ."</td><td width=\"10%\"></td><td></td><td><input type='text' name='mostpopreviews' value='". $row['mostpopreviews'] ."' size='4' maxlength='4' /></td></tr>\n";
...
echo "<input type='hidden' name='op' value='ReviewsSaveSettings' />\n";
