...
<strong>1) ".$lang_new[$module_name]['PROMOTE_RATING_TEXT_REVIEW']."</strong><br /><br />

".$lang_new[$module_name]['INFO_PROMOTE_2']."<br /><br />
<center><a href=\"".EVO_SERVER_URL."/modules.php?name=$module_name&amp;op=ratereview&amp;rid=$rid\">".$lang_new[$module_name]['DO_RATE']." @ ".EVO_SERVER_SITENAME."</a></center><br /><br />
<center>".$lang_new[$module_name]['INFO_PROMOTE_HTML_CODE_1']."</center><br />
<center><em>&lt;a href=\"".EVO_SERVER_URL."/modules.php?name=$module_name&amp;op=ratereview&amp;rid=$rid\"&gt;".$lang_new[$module_name]['DO_RATE']."&lt;/a&gt;</em></center>
<br /><br />
".$lang_new[$module_name]['PROMOTE_RATING_THE_NUMBER']." \"$rid\" ".$lang_new[$module_name]['PROMOTE_RATING_ID_REFERER']."<br /><br />

<strong>2) ".$lang_new[$module_name]['PROMOTE_RATING_BUTTON_REVIEW']."</strong><br /><br />
...
<input type=\"hidden\" name=\"op\" value=\"ratereview\" />\n
...
&nbsp;&nbsp;&lt;input type=\"hidden\" name=\"op\" value=\"ratereview\"&gt;<br />\n
...
if ( !$reviewsconfig['securitycheck'] ) {
echo "

<strong>3) ".$lang_new[$module_name]['PROMOTE_RATING_FORM']."</strong><br /><br />

".$lang_new[$module_name]['INFO_PROMOTE_4']."<br />
...
<input type=\"hidden\" name=\"ratingrid\" value=\"$rid\" />
...
&lt;table align=\"center\" border=\"0\" width=\"175\" cellspacing=\"0\" cellpadding=\"0\"&gt;<br />
    ...
    &lt;/select&gt;<br />
    &lt;/td&gt;&lt;td valign=\"top\"&gt;<br />
    &lt;input type=\"hidden\" name=\"ratingrid\" value=\"$rid\"&gt;<br />
...
echo "<br /><br /><center>".$lang_new[$module_name]['INFO_PROMOTE_5']."<br /><br />- ".EVO_SERVER_SITENAME." -<br />".$lang_new[$module_name]['REVIEWS_SIGNATURE']."<br /><br /></center>";
CloseTable();
