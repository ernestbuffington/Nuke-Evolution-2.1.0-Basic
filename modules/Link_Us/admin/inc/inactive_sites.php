...
$num = 0;
$result = $db->sql_query("SELECT `id`, `site_name`, `site_url`, `site_image`, `site_description`, `site_hits`, `site_status`, `date_added` FROM `"._LINKUS_TABLE."` WHERE `site_status` = '0' AND `button_type` = '1'");
...
$num = 0;
$result = $db->sql_query("SELECT `id`, `site_name`, `site_url`, `site_image`, `site_description`, `site_hits`, `site_status`, `date_added` FROM `"._LINKUS_TABLE."` WHERE `site_status` = '0' AND `button_type` = '2'");
$numrows = $db->sql_numrows($result);
...
$num = 0;
$result = $db->sql_query("SELECT `id`, `site_name`, `site_url`, `site_image`, `site_description`, `site_hits`, `site_status`, `date_added` FROM `"._LINKUS_TABLE."` WHERE `site_status` = '0' AND `button_type` = '3'");
$numrows = $db->sql_numrows($result);
