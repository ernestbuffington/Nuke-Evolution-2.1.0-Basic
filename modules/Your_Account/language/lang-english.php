...
define("_BROADCASTTEXT","You can send a <em>Public Message</em> from here (255 characters max). This message will be displayed to all online users in the next 10 minutes. Any user online will see your message just once in a red bar under the site's logo. Any user can deactivate this feature from <a href='modules.php?name=Your_Account&op=edithome'>here</a>. Please don't abuse. HTML code isn't allowed here.");
...
define("_EXTRAINFO","More Informations");
...
define("_NOPOSTSUBJECT","<em>No Subject</em>");
...
define("_TOAPPLY","was registered with an account at");
...
define("_TRUNCATES","(Truncates long comments, and adds a <em>Read More</em> link. Set really big to disable)");
...
define("_YA_MUSTSUPPLY","You must supply your <em>username</em> or your <em>email address</em>.");
define("_YA_NA","N/A");
define("_YA_NEWAVATAR","Your New Avatar");
define("_YA_NICKLENGTH","Nickname must be ".$evoconfig['nick_min']." to ".$evoconfig['nick_max']." characters long.");
...
define("_YA_PASSLENGTH","Password must be ".$evoconfig['pass_min']." to ".$evoconfig['pass_max']." characters long.");
...
define("_YA_SAVECHANGES","Save Changes");
...
define("_YA_XData_too_long", "XData too long: %s");
define("_YA_XData_invalid", "XData invalid: %s");
define("_YICQ","Your ICQ");
define("_YIM","Your YIM");
define("_YINTERESTS","Your Interests");
define("_YLOCATION","Your Location");
define("_YMSNM","Your MSN Adress");
...
define("_YOUUSEDEMAIL","This email account"); //e-mail
...
define("_COOKIEPATHNOTE1","Only if <em>Logout when windows close</em><br /> is not selected");
