...
if(is_mod_admin($module_name)) {
    global $admin_file, $db, $_GETVAR, $evoconfig;
    ...
    echo "<input type='hidden' name='file' value='deleteUserConf' />\n";
    echo "<input type='hidden' name='del_uid' value='$chng_uid' />\n";
    echo "<tr><td align=center>"._SURE2DELETE." <strong>$hisname<em>($chng_uid)</em></strong>?</td></tr>\n";
