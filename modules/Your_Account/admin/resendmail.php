...
if(is_mod_admin($module_name)) {
    ...
    list($uname) = $db->sql_fetchrow($db->sql_query("SELECT username FROM "._USERS_TEMP_TABLE." WHERE user_id='$chng_uid'"));
    ...
    echo "<input type='hidden' name='file' value='resendMailConf' />\n";
    echo "<input type='hidden' name='rsn_uid' value='$chng_uid' />\n";
    echo "<tr><td align=center>"._SURE2RESEND." <strong>$uname<em>($chng_uid)</em></strong>?</td></tr>\n";
