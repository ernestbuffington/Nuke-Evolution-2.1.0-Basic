...
global $db, $evoconfig, $_GETVAR, $board_config;
...
echo "<tr><td bgcolor='$bgcolor2'><div class=\"textbold\">"._EMAIL.":</div></td><td bgcolor='$bgcolor1'><input type='text' name='ya_user_email' value='$form_user_email' size='40' maxlength='255' />&nbsp;<span class='tiny'>"._REQUIRED."</span></td></tr>\n";

// menelaos: added configurable doublecheck email routine
if ($evoconfig['doublecheckemail']==1) {
echo "<tr><td bgcolor='$bgcolor2'><div class=\"textbold\">"._RETYPEEMAIL.":</div></td><td bgcolor='$bgcolor1'><input type='text' name='ya_user_email2' value='$form_user_email2' size='40' maxlength='255' /></td></tr>\n";
} else {
