...
global $db, $_GETVAR, $admin_file;

$activatedid = $_GETVAR->get('did', '_REQUEST', 'int', 0);
$min         = $_GETVAR->get('min', '_REQUEST', 'int', 0);

$db->sql_uquery("UPDATE `"._DOWNLOADS_DOWNLOADS_TABLE."` SET `download_active`='1' WHERE `did`='".$activatedid."'");
