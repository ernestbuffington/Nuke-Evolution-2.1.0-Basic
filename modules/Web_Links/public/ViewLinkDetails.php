...
$lidrow = $db->sql_ufetchrow("SELECT `lid`, `hits`, `linkratingsummary`, `totalcomments`, `totalvotes`  FROM `"._WEBLINKS_LINKS_TABLE."` WHERE `lid`='".$lid."'");
if ($lidrow['lid'] == $lid) {
    linkshowsingle($lid);
    CloseTable();
    OpenTable();
    ...
    echo "<center><span class='option'><strong>".$lang_new[$module_name]['LINK_PROFILE'].":&nbsp;".$displaytitle."</strong></span>\n";
    echo linkinfomenu($lid, $ttitle);
    $votesDB  = $db->sql_query("SELECT `rating`, `ratinguser` FROM `"._WEBLINKS_VOTEDATA_TABLE."` WHERE `ratinglid` = '".$lid."'");
    ...
    $rounding       = $weblinksconfig['detailvotedecimal'];
    ...
    if ($totalvotesDB > 0) {
        ...
        echo $lang_new[$module_name]['RATING_OVERALL'].":&nbsp;".round($lidrow['linkratingsummary'], $rounding)."\n";
         if (is_admin()) {
            if ($totalvotes != $lidrow['totalvotes']) {
                echo "There is a difference between Table Votedata and stored value in Weblinks for totalvotes";
            }
        }
        ...
        echo "</td></tr>\n";
        echo "<tr><td bgcolor='".$bgcolor2."'><span class='content'>".$lang_new[$module_name]['RATING_LINK'].":</span></td><td bgcolor='".$bgcolor2."'><span class='content'>".$ddr['avg']."</span></td></tr>\n";
        echo "<tr><td bgcolor='".$bgcolor1."'><span class='content'>".$lang_new[$module_name]['RATING_LINK_HIGHEST'].":</span></td><td bgcolor='".$bgcolor1."'><span class='content'>".$ddr['maxV']."</span></td></tr>\n";
        echo "<tr><td bgcolor='".$bgcolor2."'><span class='content'>".$lang_new[$module_name]['RATING_LINK_LOWEST'].":</span></td><td bgcolor='".$bgcolor2."'><span class='content'>". $ddr['minV']."</span></td></tr>\n";
        echo "<tr><td colspan='3'></td></tr>\n";
        // Output of Guest Votes
        echo "<tr><td colspan='3'><span class='tiny'><br /><br />".$lang_new[$module_name]['RATING_WEIGHT_NOTE']."&nbsp;".$weblinksconfig['anonweight']."&nbsp;".$lang_new[$module_name]['TO']."&nbsp;1.</span></td></tr>\n";
        ...
        echo "</td></tr>\n";
        echo "<tr><td bgcolor='".$bgcolor2."'><span class='content'>".$lang_new[$module_name]['RATING_LINK'].":</span></td><td bgcolor='".$bgcolor2."'><span class='content'>".$dda['avg']."</span></td></tr>\n";
        echo "<tr><td bgcolor='".$bgcolor1."'><span class='content'>".$lang_new[$module_name]['RATING_LINK_HIGHEST'].":</span></td><td bgcolor='".$bgcolor1."'><span class='content'>".$dda['maxV']."</span></td></tr>\n";
        echo "<tr><td bgcolor='".$bgcolor2."'><span class='content'>".$lang_new[$module_name]['RATING_LINK_LOWEST'].":</span></td><td bgcolor='".$bgcolor2."'><span class='content'>". $dda['minV']."</span></td></tr>\n";
        echo "<tr><td colspan='3'></td></tr>\n";
        // Output of  Votes from external sites
        echo "<tr><td colspan='3'><span class='tiny'><br /><br />".$lang_new[$module_name]['RATING_WEIGHT_OUTNOTE']."&nbsp;".$weblinksconfig['outsideweight']."&nbsp;".$lang_new[$module_name]['TO']."&nbsp;1.</span></td></tr>\n";
        ...
        echo "</td></tr>\n";
        echo "<tr><td bgcolor='".$bgcolor2."'><span class='content'>".$lang_new[$module_name]['RATING_LINK'].":</span></td><td bgcolor='".$bgcolor2."'><span class='content'>".$ddo['avg']."</span></td></tr>\n";
        echo "<tr><td bgcolor='".$bgcolor1."'><span class='content'>".$lang_new[$module_name]['RATING_LINK_HIGHEST'].":</span></td><td bgcolor='".$bgcolor1."'><span class='content'>".$ddo['maxV']."</span></td></tr>\n";
        echo "<tr><td bgcolor='".$bgcolor2."'><span class='content'>".$lang_new[$module_name]['RATING_LINK_LOWEST'].":</span></td><td bgcolor='".$bgcolor2."'><span class='content'>". $ddo['minV']."</span></td></tr>\n";
        echo "<tr><td colspan='3'></td></tr>\n";
        echo "</table>\n";
    } else {
