...
$lang_new[$module_name]['ADMIN_ADD_LINK'] = 'Add a Link';
$lang_new[$module_name]['ADMIN_ADD_SUBCAT'] = 'Add a SubCategory';
$lang_new[$module_name]['ADMIN_BROKEN_LINK'] = 'Manage broken Links';
...
$lang_new[$module_name]['ADMIN_LINK_VALIDATE'] = 'Validate Links';
...
$lang_new[$module_name]['ADMIN_MODIFY_LINK'] = 'Modify Links';
...
$lang_new[$module_name]['ADMIN_SETTING_BLOCK_IMAGE_SHOW'] = 'Show Images';
...
$lang_new[$module_name]['ADMIN_SETTING_GENERAL_POPULAR_PERCENT'] = 'Should Popular Links be shown as Percent<br />(otherwise they are shown as #/Total links)?';
...
$lang_new[$module_name]['ADMIN_SETTING_GENERAL_TOPLINKS_PERCENT'] = 'Should TopLinks be shown as Percent<br />(otherwise they are shown as #/Total links)?';
